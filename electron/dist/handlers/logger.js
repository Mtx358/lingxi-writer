...
exports.registerLoggerHandlers = registerLoggerHandlers;
...
function registerLoggerHandlers() {
    (0, shared_1.safeIpcHandle)('logger:write', (_event, level, message, fields) => {
        ...
        try {
            logger_1.logger.write(lvl, msg, taggedFields);
        }
        catch {
